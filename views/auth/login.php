...
<head>
    ...
    <script>
        ...
        posthog.init('<?php echo defined("POSTHOG_PROJECT_API_KEY") ? POSTHOG_PROJECT_API_KEY : ""; ?>', {
            api_host: '<?php echo defined("POSTHOG_HOST") ? POSTHOG_HOST : "https://us.i.posthog.com"; ?>',
