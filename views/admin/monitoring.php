...
<div class="mon-header">
    ...
    <div class="mon-header-left">
        ...
        <a href="https://us.posthog.com/project/<?php echo defined('POSTHOG_PROJECT_ID') ? POSTHOG_PROJECT_ID : '484728'; ?>/events" target="_blank" title="فتح إجمالي السجلات في PostHog" style="font-size:0.78rem; color:var(--text-secondary); text-decoration:none; display:inline-flex; align-items:center; gap:5px; padding:5px 10px; border-radius:8px; border:1px solid var(--border-color); transition:all 0.2s; cursor:pointer;" onmouseover="this.style.background='#f3f0ff'; this.style.color='#7c3aed'; this.style.borderColor='#7c3aed';" onmouseout="this.style.background=''; this.style.color=''; this.style.borderColor='';"><i class="fas fa-database"></i> إجمالي السجلات: <strong style="color:var(--primary)"><?php echo number_format($stats['total_logs']); ?></strong> <i class="fas fa-external-link-alt" style="font-size:0.65rem; opacity:0.6;"></i></a>
    </div>
</div>
